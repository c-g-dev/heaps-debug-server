...
var heaps_debug_browser_API = $hx_exports["HDS"] = function() { };
$hxClasses["heaps.debug.browser.API"] = heaps_debug_browser_API;
heaps_debug_browser_API.__name__ = "heaps.debug.browser.API";
heaps_debug_browser_API.updateObjectField = function(objectId,fieldName,value) {
	heaps_debug_browser_UpdateObjectField.run(objectId,fieldName,value);
};
var heaps_debug_browser_Main = function() { };
$hxClasses["heaps.debug.browser.Main"] = heaps_debug_browser_Main;
heaps_debug_browser_Main.__name__ = "heaps.debug.browser.Main";
heaps_debug_browser_Main.main = function() {
	var _ = heaps_debug_browser_API;
};
var heaps_debug_browser_UpdateObjectField = function() { };
$hxClasses["heaps.debug.browser.UpdateObjectField"] = heaps_debug_browser_UpdateObjectField;
heaps_debug_browser_UpdateObjectField.__name__ = "heaps.debug.browser.UpdateObjectField";
heaps_debug_browser_UpdateObjectField.run = function(objectId,fieldName,value) {
	var code = heaps_debug_browser_UpdateObjectField.buildScript(objectId,fieldName,value);
	heaps_debug_browser_UpdateObjectField.sendEval(code);
};
heaps_debug_browser_UpdateObjectField.buildScript = function(objectId,fieldName,value) {
	var valueExpr = heaps_debug_browser_UpdateObjectField.toHScriptLiteral(value);
	var sb_b = "";
	sb_b += "var o = get2d(\"";
	sb_b += objectId == null ? "null" : "" + objectId;
	sb_b += "\");\n";
	sb_b += "o.";
	sb_b += fieldName == null ? "null" : "" + fieldName;
	sb_b += " = ";
	sb_b += valueExpr == null ? "null" : "" + valueExpr;
	sb_b += ";\n";
	return sb_b;
};
heaps_debug_browser_UpdateObjectField.toHScriptLiteral = function(v) {
	...
	case 6:
		if(_g.c == String) {
			...
			while(i < s.length) {
				...
				if(c == null) {
					out_b += Std.string(String.fromCodePoint(c));
				} else {
					switch(c) {
					case 9:
						out_b += "\\t";
...
heaps_debug_browser_UpdateObjectField.quoteString = function(s) {
	var out_b = "";
	out_b += "\"";
	var i = 0;
	while(i < s.length) {
...
heaps_debug_browser_UpdateObjectField.sendEval = function(code) {
	fetch('/eval', { method: 'POST', headers: { 'Content-Type': 'text/plain' }, body: code });
};
